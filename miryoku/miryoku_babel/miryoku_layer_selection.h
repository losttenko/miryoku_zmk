...
#include "miryoku_layer_alternatives.h"
    ...
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_BEAKLROCK
    #endif
  #else
    #if defined (MIRYOKU_ALPHAS_AZERTY)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_BEAKLROCK)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_BEAKLROCK
